...
predictor.fit(train_data, hyperparameters={'model': model,'epochs': 25},
              hyperparameter_tune_kwargs={'searcher': 'bayesopt', 'num_trials': 7}, time_limit=60*10000)  # you can trust the default config, we reduce the # epoch to save some build time
